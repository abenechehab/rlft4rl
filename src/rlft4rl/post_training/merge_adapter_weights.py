...
# Example usage:
# python scripts/merge_adapter_weights.py --peft_model_id falcon-180b-lora-fa
# --output_dir merged-weights --save_tokenizer True
...
if args.push_to_hub:
    repo_id = (
        args.repository_id if args.repository_id else args.peft_model_id.split("/")[-1]
    )
